...
class ECategory extends Component{
    ...
    searchText = async (e) => {
        ...
        if(!!inputValue){
            ...
            this.props.history.push({pathname: `/explore_entertainment_category/${inputValue}`, state: {arr,entertainment}})
        }
    }
        ...
        <div className="col-md-9 hidden-xs" style={{marginTop:"15px"}}>
            <div  className="">
               ...
               <span type="" name='Category' className="button_globalclassName" style={{marginRight: '10px'}}>
                   <Link rel="noopener noreferrer" to={{pathname: `/explore_entertainment_category/${'Movies'}`, state: {movies, entertainment}}} style={{color:'black',fontSize:'17px',margin: '21px'}}>Movies</Link>
               </span>
               <span type="" name='buySell' className="button_globalclassName">
                   <Link rel="noopener noreferrer" to={{pathname: `/explore_entertainment_category/${'Dramas'}`, state: {dramas, entertainment}}} style={{color:'black',fontSize:'17px',margin: '21px'}}>Dramas</Link>
               </span>
               {/*<span type="" name='events' className="button_globalclassName">
                   <Link rel="noopener noreferrer" to={{pathname: `/explore_entertainment_category/${'Musics'}`, state: {musics, entertainment}}} style={{color:'black',fontSize:'17px',margin: '21px'}}>Music</Link>
               </span> */}
               <span type="" name='EcommerceMarket' className="button_globalclassName">
                   <Link rel="noopener noreferrer" to={{pathname: `/explore_entertainment_category/${'Sports'}`, state: {sports, entertainment}}} style={{color:'black',fontSize:'17px',margin: '21px'}}>Sports</Link>
               </span>
               <span type="" name='EcommerceMarket' className="button_globalclassName">
                   <Link rel="noopener noreferrer" to={{pathname: `/explore_entertainment_category/${'News'}`, state: {news, entertainment}}} style={{color:'black',fontSize:'17px',margin: '21px'}}>News</Link>
               </span>
               <span type="" name='EcommerceMarket' className="button_globalclassName">
