        ...
        return(
            <div className="container" style={{width:"70%"}}>
                <div className="row">
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-4 col-xs-6" onClick={() => {this.clickItem('shopping')}} style={{cursor:'pointer'}}>
                        <div className="wrimagecard wrimagecard-topimage">
                            <div className="wrimagecard-topimage_header">
                                <center>
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-4 col-xs-6" onClick={() => {this.clickItem('night life')}} style={{cursor:'pointer'}}>
                        <div className="wrimagecard wrimagecard-topimage">
                            <div className="wrimagecard-topimage_header">
                                <center>
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-4 col-xs-6" onClick={() => {this.clickItem('active life')}} style={{cursor:'pointer'}}>
                        <div className="wrimagecard wrimagecard-topimage">
                            <div className="wrimagecard-topimage_header">
                                <center>
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-4 col-xs-6" onClick={() => {this.clickItem('beauty & spa')}} style={{cursor:'pointer'}}>
                        <div className="wrimagecard wrimagecard-topimage">
                            <div className="wrimagecard-topimage_header">
                                <center>
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-4 col-xs-6" onClick={() => {this.clickItem('automotive')}} style={{cursor:'pointer'}}>
                        <div className="wrimagecard wrimagecard-topimage">
                            <div className="wrimagecard-topimage_header">
                                <center>
