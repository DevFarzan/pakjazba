                ...
                <div className="row">
                    ...
                    <div className="col-md-3">
                        <div className="media">
                            <div className="media-left">
                                <a>
                                    <img  className="media-object" src="../images/how to upload/profile (1).png" alt="..." style={{width: '100%',marginTop: '6px'}}/>
                                </a>
                            </div>
                    ...
                    <div className="col-md-3">
                        <div className="media">
                            <div className="media-left">
                                <a>
                                    <img  className="media-object-2" src="../images/how to upload/submityourad.png" alt="..." style={{width:"100%",marginTop: '11px'}}/>
                                </a>
                            </div>
                            <div className="media-body col-md-3" style={{marginLeft: "-15px"}}>
                    ...
                    <div className="col-md-3">
                        <div className="media">
                            <div className="media-left">
                                <a>
                                    <img className="media-object-2" src="../images/how to upload/deal-done.png" alt="..." style={{width:"100%",marginTop:'18px'}}/>
                                </a>
                            </div>
                    ...
                    <div className="col-md-3">
                        <div className="media">
                            <div className="media-left">
                                <a>
                                    <img className="media-object-2" src="../images/how to upload/payment.png" alt="..." style={{width:"100%"}} />
                                </a>
                            </div>
                            <div className="media-body col-md-3">
