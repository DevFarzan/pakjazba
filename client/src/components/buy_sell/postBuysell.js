    ...
    componentDidMount(){
        ...
        if(data){
            this.setState({
                ...
                dLength: data.sizedimension[0].length || this.state.dLength,
                dWidth: data.sizedimension[0].width || this.state.dWidth,
                dHeight: data.sizedimension[0].height || this.state.dHeight,
