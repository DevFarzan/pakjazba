...
class TicketDetail extends Component{
  ...
  //     console.log(input, 'kkkkkkkkkkkk')
  //     const displayDiv = input.innerHTML += `<span>
  ...
  //         </div>
  //     </span>`;
  //     console.log(displayDiv, 'inputttttttttt')
  ...
  purchaseTicket(){
    ...
    // mainDiv.addClass
      const input = document.getElementById('divIdToPrint');
      // console.log(mainDiv, 'lllllllllll')
      html2canvas(input)
          .then((canvas) => {
              console.log(canvas, 'canvasssssssss')
              const imgData = canvas.toDataURL('image/png');
              ...
              <div className="row">
                ...
                <div className="col-md-10 col-sm-12" style={{border: '1px solid #D3D3D3', marginTop: '-20px'}}>
                  ...
                  <div className="col-md-4" style={{marginTop: '10px'}}>
                    <img src={data.data.images[0]} style={{width:"100%", height:"100px"}}/>
                    <QRCode value="helloFarzanBhai" style={{marginTop:"100px"}}/>
                  </div>
                </div>
              </div>
            </div>
