    ...
    <div className="container" style={{marginLeft:"10px", width:"100%",}}>
      <div className="col-md-10">
        <Carousel autoplay>
            ...
            <div><img src="../images/black.jpg" style={{width: "100%", height:"400px"}}/></div>
            <div><img src="../images/blog.jpg" style={{width: "100%", height:"400px"}}/></div>
            <div><img src="../images/blog1.jpg" style={{width: "100%", height:"400px"}}/></div>
        </Carousel>
      </div>
    </div>
  </div>
