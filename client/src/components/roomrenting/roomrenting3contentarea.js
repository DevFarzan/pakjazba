...
<div className="carousel-inner">
    <div className="item active">
      <img src="./images/black1.jpg" className="img-responsive" />
    </div>

    <div className="item">
      <img src="./images/black1.jpg" />
    </div>
...
<img src="./images/black.jpg" alt="" className="responsive img-rounded" height="200" width="300" />
</div>
...
<div className="row">
  ...
  <div className="col-md-3 col-sm-12 col-xs-12 ">
    ...
    <div className="checkbox">
<h4> <label><input type="checkbox" value="" checked="checked" />Quality Wood</label> </h4></div>
  ...
  <div className="col-md-12 col-sm-12 col-xs-12 des-space auther-border ">
    ...
    <div className="">
      ...
      <div className="col-md-6 col-sm-12 col-xs-12">
        ...
        <img src="./images/black1.jpg" className="img-circle" alt="" height="200" width="200" />
        <h3>
